...
```{r plot horses, fig.width=10, fig.height=3, fig.cap="Figure 1. Horse populations for all provinces in Canada between 1940 and 1972.", out.width="100%" }
...
knitr::kable(
  max_horses,
  caption = "Table 1. Maximum and minimum number of horses for each province between 1940 and 1972."
)
```

Below we zoom in and look at the province of Alberta:

```{r plot province, fig.width=5, fig.height=4, fig.cap = "Figure 2. Number of horses for province of focus.", out.width="100%"}
